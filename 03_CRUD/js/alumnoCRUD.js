...
const agregarAlumno=async()=>{
  var control=document.querySelector("#control").value;
  var nombre=document.querySelector("#nombre").value;
  var fecha=document.querySelector("#fecha").value;
  var grupo=document.querySelector("#grupo").value;
  var carrera=document.querySelector("#carrera").value;

  if(control.trim()===''|| nombre.trim()===''|| fecha.trim()==='' ||
     grupo.trim()===''|| carrera.trim()===''){
      Swal.fire({
          icon: 'error',
          title: 'ERROR',
...
const cargarAlumno=async(alumnoid)=>{
  ...
  datos.append("alumnoid",alumnoid);
    ...
    document.querySelector("#econtrol").value=resultado.control;
    document.querySelector("#enombre").value=resultado.nombre;
    document.querySelector("#efecha").value=resultado.fecha;
    document.querySelector("#grupoEdit").value=resultado.grupo;
    document.querySelector("#carreraEdit").value=resultado.carrera;
...
const editarAlumno=async()=>{
    ...
    var control=document.querySelector("#econtrol").value;
    var nombre=document.querySelector("#enombre").value;
    var fecha=document.querySelector("#efecha").value;
    var grupo=document.querySelector("#grupoEdit").value;
    var carrera=document.querySelector("#carreraEdit").value;
